  ...
  return <div>
    <section className="mx-auto grid max-w-[1400px] gap-10 px-4 pb-12 pt-14 sm:px-8 sm:pt-20 lg:grid-cols-[1.15fr_.85fr] lg:items-end lg:gap-16 lg:pb-24">
      <div className="max-w-[760px]">
        ...
        <h1 className="max-w-[720px] text-[clamp(3.5rem,10vw,8.5rem)] font-semibold leading-[.87] tracking-[-0.085em]">Who’s in the <span className="text-[var(--accent)]">room?</span></h1>
        ...
        <div className="mt-9 flex flex-wrap items-center gap-3"><Link to="/join"><ArrowButton>Join the room</ArrowButton></Link><a href="#room" className="inline-flex min-h-11 items-center gap-2 px-2 text-sm font-semibold text-[var(--muted)] transition hover:text-[var(--ink)]">See the room <ArrowUpRight size={16} /></a></div>
      </div>
